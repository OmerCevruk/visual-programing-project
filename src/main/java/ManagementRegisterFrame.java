...
public class ManagementRegisterFrame extends javax.swing.JFrame {

private final JDBCPostgreSQLConnection connect;

    public ManagementRegisterFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        ManagementLogin.setText("Management ");
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        try (Connection conn = connect.connect()) {
            String sql = "INSERT INTO public.manager(\"FullName\", \"Password\") VALUES (?, ?)";
