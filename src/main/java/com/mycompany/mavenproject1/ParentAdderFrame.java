...
public class ParentAdderFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentDataPanel.setLayout(new java.awt.GridLayout(7, 2, 0, 5));
        ...
        studentDataPanel.add(ParentidLabel);

        parentid.setText("enter parent id");
        studentDataPanel.add(parentid);
    ...
    private void addParentButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addParentButtonActionPerformed
        ...
        int parentIDValue = Integer.parseInt(parentid.getText());
        ...
        try (Connection conn = connect.connect()) {
            String sql = "INSERT INTO public.parent(\"FullName\", \"Email\", \"Password\", \"DOB\", \"Address\", \"CityID\" , \"ParentID\") VALUES (?, ?, ?, ?, ?, ?, ? )";
            ...
            pstmt.setInt(7, parentIDValue);
            pstmt.executeUpdate();

            JOptionPane.showMessageDialog(this, "Parent added successfully");
